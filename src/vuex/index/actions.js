/*
 * @Author: jack.lu 
 * @Date: 2018-3-8 14:15:12 
 * @Last Modified by: jack.lu
 * @Last Modified time: 2018-12-29 23:58:08
 */


import { Notification, MessageBox } from 'element-ui';
import axiosApi from 'apis/index/index';
...
export default {
    ...
    handleConfirm({ commit }, products) { //全局弹框 确定&取消
        let { msg, title, success, error } = products;
        ...
        axiosApi[axiosName](params)
            .then((res) => {
                if (res.returnSuccess) {
                    ...
                    let errMsg = res.returnErrMsg ? res.returnErrMsg : '网络异常，请重试';
            ...
            .catch((err) => {
                dispatch('notifyError', '网络异常，请刷新或重新登录');
                console.error(err);
                state.loadingStatus = false;
            })
    },
